...
<div class="settings-page">
    ...
    <!-- Settings layout: sidebar + frame -->
    <div class="settings-layout">

        <!-- Settings sidebar navigation -->
        <aside class="settings-nav">
            <h2 class="settings-nav-title"><i class="fa fa-gear"></i> Settings</h2>
            <button class="settings-nav-item active" onclick="showSettingsPanel('account', this)">
                <i class="fa fa-user-shield"></i> Account
            </button>
            <button class="settings-nav-item" onclick="showSettingsPanel('preferences', this)">
                <i class="fa fa-sliders"></i> Preferences
            </button>
            <button class="settings-nav-item" onclick="showSettingsPanel('privacy', this)">
                <i class="fa fa-lock"></i> Privacy
            </button>
            <button class="settings-nav-item" onclick="showSettingsPanel('danger', this)">

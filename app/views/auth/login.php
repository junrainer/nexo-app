...
<div class="auth-split-page">
    ...
    <div class="auth-form-panel">
        <div class="auth-form-card">
            ...
            <!-- Toggle tabs: Sign In active -->
            <div class="auth-tab-toggle">
                <button class="auth-tab-btn active" id="tabSignIn"
                        type="button" onclick="switchAuthTab('signin')">Sign In</button>
                <button class="auth-tab-btn" id="tabCreateAccount"
                        type="button" onclick="switchAuthTab('register')">Create Account</button>
            </div>

            <!-- Flash messages (login errors land here) -->
            ...
            <div id="authFormSignIn" class="auth-tab-pane">
            ...
            <!-- ── REGISTER FORM (hidden on this page) ────────────── -->
            <div id="authFormRegister" class="auth-tab-pane" style="display:none">

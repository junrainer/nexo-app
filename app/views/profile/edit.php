    ...
    <div class="form-card">
        ...
        <form action="/profile/update" method="POST" enctype="multipart/form-data" class="auth-form">
            <div class="avatar-upload-wrap">
                <img src="/assets/uploads/<?= htmlspecialchars($user['profile_image']) ?>" alt="avatar" class="avatar-profile" id="avatar-preview" onerror="this.onerror=null; this.src='/assets/images/default.png'">

...
class PostMediaModel {
    ...
    private function ensureTable(): bool {
        try {
            ...
            error_log('PostMediaModel::ensureTable failed to create post_media with foreign key constraints (will retry without constraints): ' . $e->getMessage());
            try {
                ...
                error_log('PostMediaModel::ensureTable failed to create post_media even without foreign key constraints: ' . $fallbackError->getMessage());
                return false;
            }
        }
    }

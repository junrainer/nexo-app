...
class PostMediaModel {
    ...
    private function ensureTable(): bool {
        try {
            ...
            error_log('PostMediaModel::ensureTable failed to create post_media table with foreign keys, retrying without constraints: ' . $e->getMessage());
            try {
                ...
                error_log('PostMediaModel::ensureTable failed to create post_media table without foreign keys. Check database permissions and configuration: ' . $fallbackError->getMessage());
                return false;
            }
        }
    }
